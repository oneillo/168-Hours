...
- (id)init
{
	...
	navButton = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(createActivity:)];
	[[self navigationItem] setRightBarButtonItem:navButton];
	[navButton release];
	
	[self setTitle:@"New Activity"];
